...
figure("OuterPosition",[100 100 800 600],"Name","W6715")
...
sgtitle("{\itd} = 215 nm; \omega-FWHM = "+num2str(getRocking("W6715"),"%.2f")+"°")
disp("export..")
exportgraphics(gcf,"../Plots/RSM/RSM_W6715.png","Resolution",300)