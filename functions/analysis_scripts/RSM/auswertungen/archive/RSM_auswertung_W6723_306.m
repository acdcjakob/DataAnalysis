...
for n = [1,2]
    ...
    qy = q_parallel{n};
    intensity = data{n};
    contourf(qx,qy,intensity,logspace(0,4.5,30),"LineStyle","none")
    hold on
end

%%
q_Al2O3_exp_306 = [4.200 ; 7.275];
    q_Cr2O3_exp_306 = [4.056 ; 6.960];
    [x,y] = correctReciprocalData(q_Cr2O3_exp_306(1),q_Cr2O3_exp_306(2),q_Al2O3_lit_306,q_Al2O3_exp_306);
    q_Cr2O3_cor_306 = [x,y];

q_Al2O3_exp_300 = [-0.0003 ; 7.274];
    q_Cr2O3_exp_300 = [-0.0009 ; 6.964];
    [x,y] = correctReciprocalData(q_Cr2O3_exp_300(1),q_Cr2O3_exp_300(2),q_Al2O3_lit_300,q_Al2O3_exp_300);
    q_Cr2O3_cor_300 = [x,y];

q_Al2O3_exp_30m6 = [-4.201 ; 7.275];
    q_Cr2O3_exp_30m6 = [-4.057 ; 6.963];
