...
figure("OuterPosition",[100 100 800 600],"Name","W6725")
...
sgtitle("{\itd} = 400 nm; \omega-FWHM = "+num2str(getRocking("W6725"),"%.2f")+"°")
disp("export..")
exportgraphics(gcf,"../Plots/RSM/RSM_W6725.png","Resolution",300)