...
samples = searchSamples_v2(...
    {{'Batch','Cr2O3_energy2';'RSM','a';'Sub','a-Al2O3'}},true);
...
exportgraphics(F,"../Plots/Cr2O3/5 energy/5-RSM_terminal_a.pdf")
exportgraphics(F,"../Plots/Cr2O3/5 energy/5-RSM_terminal_a.png","Resolution",250)