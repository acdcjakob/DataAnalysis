...
plotHall_v4();
    ...
    HZnO = H;
    xlabel("Laser position on target (mm)")
...
linkaxes(axmatrix,'y')
ylim([1e-2 2e1])
% sgtitle("\rho vs. Laser Position during PLD")

linePainter(HZnO);
linePainter([gobjects(2,2);HCuO])

%%
exportgraphics(F,"../Plots/Cr2O3/2 CompVar/2-rho_vs_y.pdf")