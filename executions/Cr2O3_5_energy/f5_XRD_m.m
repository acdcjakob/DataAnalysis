...
for i = 1:length(L)
    ...
    Specs_XRD.value1 = "%%$Cr2O3_energy$m-Al2O3$a$"+L{i};
...
S = {0,1,2};
for i = [1,2,3]
    linePainter(Htot{i},"start",CM{i}(1,:),"end",CM{i}(2,:),"shiftColumn",S{i},"width",2)
end
% Htot{3}.Color = [0 0 0];
% Htot{3}.LineStyle = ":";
...
xlim([64 66])
xline(65.11,"DisplayName","reference (30.0)")
exportgraphics(gcf,"../Plots/Cr2O3/5 energy/5-XRD_m.png","Resolution",250)
exportgraphics(gcf,"../Plots/Cr2O3/5 energy/5-XRD_m.pdf")
