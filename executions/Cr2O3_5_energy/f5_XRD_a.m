...
for i = 1:length(L)
    ...
    Specs_XRD.value1 = "%%$Cr2O3_energy$a-Al2O3$a$"+L{i};
...
xlim([35 36.5])
xline(36.2,"DisplayName","reference (11.0)")
exportgraphics(gcf,"../Plots/Cr2O3/5 energy/5-XRD_a.png","Resolution",250)
exportgraphics(gcf,"../Plots/Cr2O3/5 energy/5-XRD_a.pdf")
