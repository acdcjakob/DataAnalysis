...
%%
cuts = [0 21;28 42; 57 75; 86 112];
filename = "temp"+date+".mat";
save(filename,"cuts");

plotXRD_v3
delete(filename);
title("Cr_2O_3:ZnO r-Sapphire")
A3.XGrid = "on";
legend(A3);
n = numel(A3.Children);
for i = 1:n
...
%%
cuts = [0 27; 46 70; 85 120; 125 135];
filename = "temp"+date+".mat";
save(filename,"cuts");

plotXRD_v3
delete(filename);
title("Cr_2O_3:ZnO a-Sapphire")
A4.XGrid = "on";
legend(A4);
n = numel(A4.Children);
for i = 1:n
...
sgtitle("Cr_2O_3:ZnO (varying Laser Position during PLD)")