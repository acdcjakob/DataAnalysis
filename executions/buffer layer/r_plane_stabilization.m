...
axis tight
grid on
sgtitle("{\itr}-plane \alpha-Ga_2O_3 on buffer layer Cr_2O_3","Fontweight","bold")
lims0 = axis(ax0);
...
xline(ax(2),get2Theta([0 2 4],"Ga2O3"),":","LineWidth",2,...
    "DisplayName","(02.4) {\alpha-Ga_2O_3}",...
    "Alpha",1,...
    "Color",[.8 .2 .2]);
xline(ax(2),get2Theta([0 2 4],"Cr2O3"),":","LineWidth",2,...
    "DisplayName","(02.4) {\alpha-Cr_2O_3}",...
    "Alpha",1,...
    "Color",[.2 .7 .2]);
...
exportgraphics(f,"../Plots/Thesis/4/4_thetaomega_r.pdf")