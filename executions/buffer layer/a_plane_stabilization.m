...
axis tight
grid on
sgtitle("{\ita}-plane \alpha-Ga_2O_3 on buffer layer Cr_2O_3","Fontweight","bold")
% ylim([1 80e3])
lims0 = axis(ax0);
...
xline(ax(2),get2Theta([2 2 0],"Ga2O3"),":","LineWidth",2,...
    "DisplayName","(22.0) {\alpha-Ga_2O_3}",...
    "Alpha",1,...
    "Color",[.8 .2 .2]);
xline(ax(2),get2Theta([2 2 0],"Cr2O3"),":","LineWidth",2,...
    "DisplayName","(22.0) {\alpha-Cr_2O_3}",...
    "Alpha",1,...
    "Color",[.2 .7 .2]);
...
exportgraphics(f,"../Plots/Thesis/4/4_thetaomega_a.pdf")
